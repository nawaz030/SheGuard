...
public final class FragmentProfileBinding implements ViewBinding {
  ...
  private FragmentProfileBinding(@NonNull CoordinatorLayout rootView,
      ...
      @NonNull MaterialTextView tvEmail, @NonNull MaterialTextView tvLocation,
      @NonNull MaterialTextView tvName, @NonNull MaterialTextView tvPhone) {
  ...
  public static FragmentProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentProfileBinding((CoordinatorLayout) rootView, btnEditProfile,
          binding_header, tvEmail, tvLocation, tvName, tvPhone);
    }
